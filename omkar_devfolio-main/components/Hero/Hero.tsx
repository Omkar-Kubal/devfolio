            ...
            <div className='flex flex-col items-center justify-center gap-16 h-screen w-full'>
                <div className="flex flex-col items-center justify-center gap-4">
                    ...
                    <div className='flex flex-col md:text-xl items-center justify-center text-center px-4 md:px-0 gap-4'>
                        <p className='text-muted-foreground'>AI-ML Developer <br/> passionate about solving real-world problems using data-driven approaches.</p> 
                        <p className='text-muted-foreground italic border-l-2 border-muted-foreground/50 pl-2'>Turning data into actionable insights</p>
                    </div>
                </div>
                <div className='flex items-center justify-center gap-4'>
                    ...
                    <Link href="https://drive.google.com/drive/folders/1hMoGM9kjne7YGKns6ptLNsgAiE_nseta?usp=sharing" target='_blank'><Button size="sm" variant="outline">Download CV <IconDownload className="w-4 h-4" /></Button></Link>
                </div>
            </div>
        </Background>
    )
