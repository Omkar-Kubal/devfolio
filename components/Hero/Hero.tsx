        ...
        <Background className="min-h-screen w-full">
            <div className='flex flex-col items-center justify-center gap-16 h-screen w-full'>
                ...
                <div className='flex items-center justify-center gap-4'>
                    ...
                    <Link href="https://drive.google.com/file/d/1Wb3h1W__QRMzaUaahyd2VazxfeWugGzY/view?usp=sharing" target='_blank'><Button size="sm" variant="outline">Download CV <IconDownload className="w-4 h-4" /></Button></Link>
                </div>
            </div>
        </Background>
    )
