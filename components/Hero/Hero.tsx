...
import { IconBrandGithub, IconBrandGooglePlay, IconDownload } from '@tabler/icons-react'
            ...
            <div className='flex flex-col items-center justify-center gap-16 h-screen w-full'>
                <div className="flex flex-col items-center justify-center gap-4">
                    ...
                    <div className='flex flex-col md:text-xl items-center justify-center text-center px-4 md:px-0 gap-4'>
                        <p className='text-muted-foreground'>ML Engineer <br />building ML-driven security systems, behavioral network detections, and production AI pipelines.<br/>Also building and shipping Android products.</p>
                        <p className='text-muted-foreground italic border-l-2 border-muted-foreground/50 pl-2'>Proven in building scalable, security-driven AI and Cyber Security solutions</p>
                    </div>
                </div>
